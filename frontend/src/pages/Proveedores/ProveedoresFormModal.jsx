// src/pages/proveedores/ProveedorFormModal.jsx
import {
...
export default function ProveedorFormModal({ open, onClose, onSave, data }) {
  ...
  const validate = () => {
    ...
    if (!form.rnc) e.rnc = "RNC obligatorio";
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      setSnackbar({
        open: true,
        msg: data ? "Proveedor actualizado" : "Proveedor creado",
        severity: "success"
      });
      onClose();
    } catch {
  ...
  return (
    <>
      <Dialog open={open} onClose={onClose} maxWidth="sm" fullWidth>
        <DialogTitle>{data ? "Editar Proveedor" : "Nuevo Proveedor"}</DialogTitle>
        ...
        <DialogContent dividers>
          <Grid container spacing={2} direction="column">
            ...
            <Grid item>
              <TextField label="RNC" fullWidth name="rnc" value={form.rnc}
                onChange={handleChange} error={!!errors.rnc} helperText={errors.rnc} />
            </Grid>
